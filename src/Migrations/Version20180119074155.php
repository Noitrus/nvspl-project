 ...
 */
class Version20180119074155 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE app_users CHANGE username username VARCHAR(25) NOT NULL COLLATE utf8_unicode_ci, CHANGE email email VARCHAR(60) NOT NULL COLLATE utf8_unicode_ci');
